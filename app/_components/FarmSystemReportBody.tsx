    ...
    <div className="prospects-report-page">
      ...
      <div style={{ border: "1px solid var(--color-border)", borderRadius: 8, padding: "12px 16px", background: "var(--color-surface)", marginBottom: 16, fontSize: "0.875rem", lineHeight: 1.5 }}>
        ...
        <p style={{ margin: "0 0 8px" }}>
          Player grades are generated by our internal evaluation system, which weighs hitting, fielding, baserunning, and
          pitching tools together into a single overall grade, calibrated against actual outcomes across the league rather
          than scouting intuition alone. Positional value is built in directly — a shortstop or catcher grades out ahead of
          a first baseman or DH carrying the same raw tools, reflecting how hard each position actually is to fill.
        </p>
        <p style={{ margin: 0 }}>
